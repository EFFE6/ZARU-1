...
const Gestion: React.FC = () => {
  ...
  const tabs = [
    'Usuarios', 'Niveles', 'Topes',
    'Parentescos', 'Parámetros', 'Sub-especialidades',
  ];
  ...
  const filteredData = useMemo(() => {
    ...
    return [];
  }, [activeTab, usuarios, niveles, topes, parentescos, parametros, subespecialidades, searchQuery, statusFilter, activeFilterTag]);
  ...
  const confirmDelete = async () => {
    ...
    try {
      let endpoint = '';
      if (activeTab === 'Usuarios') endpoint = 'usuarios';
      ...
      if (endpoint) {
        ...
        if (activeTab === 'Usuarios') setUsuarios(u => u.filter(x => x.id !== itemToDelete.id));
      ...
      <main className="main-content">
        <div className="gestion-container">
          ...
          <div className="tabs-card-group">
            ...
            <div className={`gestion-content-card ${activeTab === 'Usuarios' ? 'first-tab-active' : ''}`}>
